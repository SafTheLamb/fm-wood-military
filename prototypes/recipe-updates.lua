...
if settings.startup["wood-military-shotgun-ammo"].value == "item" then
  -- try and avoid 4 item cost for shotgun shells
...
if settings.startup["wood-military-hard-mode"].value then
  ...
  Recipe("piercing-shotgun-shell"):add_ingredient({"plastic-bar", 5})
end
...
if modutil.sniper_rifle then
  ...
  if settings.startup["wood-military-hard-mode"].value then
    ...
    Recipe("sniper-magazine-2"):add_ingredient({"plastic-bar", 5})
