if mods["distant-misfires"] then
  ...
  if settings.startup["wood-military-smg-ammo"].value then
    data.raw.projectile["wood-darts-magazine"].animation.filename = "__wood-military__/graphics/entity/wood-bullet/wood-bullet.png"
  ...
  if mods["sniper-rifle-improved"] and settings.startup["wood-military-sniper-ammo"].value then
    data.raw.projectile["wood-bolts-magazine"].animation.filename = "__wood-military__/graphics/entity/wood-bullet/wood-bullet.png"
